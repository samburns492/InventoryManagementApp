...
/** Creates a controller class which handles modifying an outsourced part and associated FXML file.  
 */
...
private Outsourced convertPartMod = new Outsourced(0," ",0.0,0,0,0);
    ...
    public void setterPartMod(Part temp) {
        ...
        if (tempPartMod instanceof Outsourced) {
        companynamefield.setText(String.valueOf(((Outsourced)tempPartMod).getCompanyName()));
        }
    }
    
    /** This method checks all fields and then saves the modified part as an outsourced child part.
    ...
    public void toSavePart(ActionEvent actionEvent) throws IOException {
        ...
        if (namefield.getText().isBlank()) {
            ...
            alert.showAndWait();
            return;
        } else if (companynamefield.getText().isBlank()) {
            alert.setHeaderText("Error");
            alert.setContentText("Company name field is empty! Modify Part failed");
            alert.showAndWait();
        } else {
            ...
            try {
                convertPartMod = new Outsourced(Integer.parseInt(idfield.getText()),namefield.getText(),Double.parseDouble(pricefield.getText()),Integer.parseInt(invfield.getText()),Integer.parseInt(minfield.getText()),Integer.parseInt(maxfield.getText()));
                convertPartMod.setCompanyName(companynamefield.getText());
     ...
     * @throws java.io.IOException
     */
    public void toModifyPart_In(ActionEvent actionEvent) throws IOException {
    ...
    /** This method launches the main form without any changes saved.
        @param actionEvent when user clicks cancel button on the modify outsource part pane.
     * @throws java.io.IOException
     */
